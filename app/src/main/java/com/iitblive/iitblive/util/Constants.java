...
public class Constants {
    public static final String GCM_SENDER_ID = "856156176188";
    public static String BASE_URL = "http://iitbapp.herokuapp.com/api/";
    public static String PUBLIC_BASE_URL = "http://iitbapp.herokuapp.com/public/api/";
    public static String BASE_URL_OPEN = "http://iitbapp.herokuapp.com/api";
    public static String GCM_REGISTER_URL = "http://iitbapp.herokuapp.com/gcm/v1/device/register/";
    public static String GCM_UNREGISTER_URL = "http://iitbapp.herokuapp.com/gcm/v1/device/unregister/";
    public static String IITB_EMAIL_EXTENSION = "@iitb.ac.in";
    ...
    public static String SP_REGISTRATION_ID = "GCM_REG_ID";
    public static String SP_GCM_REGISTERED = "GCM_REG_STATUS";
